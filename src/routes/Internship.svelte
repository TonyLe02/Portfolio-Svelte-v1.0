...
<section id="internship" class="bg-nero text-white p-8">
  ...
  <p>
    <a
      ...
      class="text-lg font-semibold text-yellow-600 hover:underline hover:text-green-500 transition-colors duration-300 ease-in-out"
    >
    ...
    <p class="mb-4">
      ...
      career path where I will immerse myself in the innovative world of
      technology.
    </p>
    <p>
      ...
      This experience is not just about professional growth; it's also about the
      excitement of being part of a dynamic team that's shaping the future of
      tech.
    </p>
    <p>
